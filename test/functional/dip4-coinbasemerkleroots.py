...
class LLMQCoinbaseCommitmentsTest(autxTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as autxTestFramework doesn't support this atm)
