// Copyright (c) 2019-2020 The autx Core developers
...
static const CRPCCommand commands[] =
    { //  category              name                      actor (function)         okSafe argNames
        //  --------------------- ------------------------  -----------------------  ------ ----------
        { "autx",               "getpoolinfo",            &getpoolinfo,            true,  {} },
        { "autx",               "getprivatesendinfo",     &getprivatesendinfo,     true,  {} },
#ifdef ENABLE_WALLET
        { "autx",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
