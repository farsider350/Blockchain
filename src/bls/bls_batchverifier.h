// Copyright (c) 2018-2019 The autx Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef autx_CRYPTO_BLS_BATCHVERIFIER_H
#define autx_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //autx_CRYPTO_BLS_BATCHVERIFIER_H
