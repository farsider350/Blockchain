    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  autx-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the autx in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 autx, 0.01 autx, 0.1 autx, 1 autx and 10 autx -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.autradex.systems/en/stable/wallets/autxcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
