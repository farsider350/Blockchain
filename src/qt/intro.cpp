    ...
    signalled(false)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the autx block chain.").arg(tr(PACKAGE_NAME)) + " " +
...
bool Intro::pickDataDirectory()
{
     ...
     * override -datadir in the autx.conf file in the default data directory
     * (to be consistent with autxd behavior)
     */
