...
//! Discourage users to set fees higher than this amount (in twigs) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in twigs)
 ...
 *  We have 4 times smaller block times in autx, so we need to push 4 times more invs per 1MB. */
...
/** Absolute maximum transaction fee (in twigs) used by wallet and mempool (rejects high fee in sendrawtransaction) */
