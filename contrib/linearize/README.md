# Linearize
Construct a linear, no-fork, best version of the autx blockchain. The scripts
...
JSON-RPC server. Running `autxd` or `autx-qt -server` will be sufficient.
...
* `input`: autxd blocks/ directory containing blkNNNNN.dat
