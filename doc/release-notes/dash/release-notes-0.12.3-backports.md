...
- [`75421c37b`](https://github.com/farsider350/autx-core/commit/75421c37b) Merge #9764: wallet: Prevent "overrides a member function but is not marked 'override'" warnings
...
- [`e2225f37c`](https://github.com/farsider350/autx-core/commit/e2225f37c) Merge #10265: [wallet] [moveonly] Check non-null pindex before potentially referencing
...
- [`818fc1eaf`](https://github.com/farsider350/autx-core/commit/818fc1eaf) Merge #9891: depends: make osx output deterministic
...
- [`132edbda8`](https://github.com/farsider350/autx-core/commit/132edbda8) Merge #9755: Bugfix: Qt/Options: Restore persistent "restart required" notice
...
- [`86753a890`](https://github.com/farsider350/autx-core/commit/86753a890) Add spaces around + in updateGlobalFeeVariables
...
- [`3bd155bd5`](https://github.com/farsider350/autx-core/commit/3bd155bd5) Merge #9561: Wake message handling thread when we receive a new block
...
- [`29d5bdb55`](https://github.com/farsider350/autx-core/commit/29d5bdb55) Fix import-rescan.py test
...
- [`a590da317`](https://github.com/farsider350/autx-core/commit/a590da317) Merge #9412: build: Fix 'make deploy' for OSX
...
- [`3aee86d6f`](https://github.com/farsider350/autx-core/commit/3aee86d6f) Merge #9334: Update to latest libsecp256k1
...
- [`27fcec08f`](https://github.com/farsider350/autx-core/commit/27fcec08f) Merge #9202: bench: Add support for measuring CPU cycles
...
- [`c937a0bfb`](https://github.com/farsider350/autx-core/commit/c937a0bfb) Merge #9186: test: Fix use-after-free in scheduler tests
...
- [`c5bfd2157`](https://github.com/farsider350/autx-core/commit/c5bfd2157) Fix version check in CBlockPolicyEstimator::Read
...
- [`77b888a06`](https://github.com/farsider350/autx-core/commit/77b888a06) Merge #8989: [Qt] overhaul smart-fee slider, adjust default confirmation target
...
- [`b02e461fa`](https://github.com/farsider350/autx-core/commit/b02e461fa) Merge #8908: Update bitcoin-qt.desktop
...
- [`6b1842af8`](https://github.com/farsider350/autx-core/commit/6b1842af8) Merge #8839: test: Avoid ConnectionResetErrors during RPC tests
...
- [`c7a0b91d3`](https://github.com/farsider350/autx-core/commit/c7a0b91d3) Merge #8793: Do not shadow in src/qt
...
- [`93e857ed9`](https://github.com/farsider350/autx-core/commit/93e857ed9) Merge #8652: [qa]: remove root test directory for RPC tests
...
- [`fc34ec4b3`](https://github.com/farsider350/autx-core/commit/fc34ec4b3) Merge #8566: Easy to use gitian building script
...
- [`ae90d0f09`](https://github.com/farsider350/autx-core/commit/ae90d0f09) Align HD wallet status icon code with Bitcoin code
...
- [`bdddabb3c`](https://github.com/farsider350/autx-core/commit/bdddabb3c) Merge #8521: qa: Remove duplicate `hash160` implementation
- [`9ecef8313`](https://github.com/farsider350/autx-core/commit/9ecef8313) Merge #8520: build: Remove check for `openssl/ec.h`
- [`599df5172`](https://github.com/farsider350/autx-core/commit/599df5172) Merge #8516: [trivial] remove no-longer-used InitError logic
- [`a953997b2`](https://github.com/farsider350/autx-core/commit/a953997b2) Merge #8058: [Doc] Add issue template
- [`bc659c3e6`](https://github.com/farsider350/autx-core/commit/bc659c3e6) Merge #8270: Tests: Use portable #! in python scripts (/usr/bin/env)
- [`a377499c1`](https://github.com/farsider350/autx-core/commit/a377499c1) Merge #8192: [trivial] Remove URLs from About dialog translations
- [`f4af44676`](https://github.com/farsider350/autx-core/commit/f4af44676) Add SYNC_TRANSACTION_NOT_IN_BLOCK constant and fix callers of SyncTransaction
- [`256b9b77a`](https://github.com/farsider350/autx-core/commit/256b9b77a) Merge #7946: Reduce cs_main locks during ConnectTip/SyncWithWallets
- [`6ba688b1c`](https://github.com/farsider350/autx-core/commit/6ba688b1c) Merge #8353: Trivial: tiny c++11 refactors
- [`cca05694c`](https://github.com/farsider350/autx-core/commit/cca05694c) Merge #8293: Bugfix: Allow building libbitcoinconsensus without any univalue
- [`7dafb5303`](https://github.com/farsider350/autx-core/commit/7dafb5303) Merge #8492: configure: Allow building bench_bitcoin by itself
- [`82336d818`](https://github.com/farsider350/autx-core/commit/82336d818) Merge #8503: [doc] typos, text errors
- [`d5b5aeefe`](https://github.com/farsider350/autx-core/commit/d5b5aeefe) Merge #8481: Qt: Fix minimize and close bugs
- [`549894bac`](https://github.com/farsider350/autx-core/commit/549894bac) Merge #8444: Fix p2p-feefilter.py for changed tx relay behavior
- [`5e54cf907`](https://github.com/farsider350/autx-core/commit/5e54cf907) Merge #8392: Fix several node initialization issues
- [`35202920f`](https://github.com/farsider350/autx-core/commit/35202920f) Merge #8439: [doc] Increase recommended memory in gitian build guide
- [`2c3a218b3`](https://github.com/farsider350/autx-core/commit/2c3a218b3) Merge #8189: rename mapAddrCount to mapNetGroupNodes
- [`7c62457e6`](https://github.com/farsider350/autx-core/commit/7c62457e6) Merge #8428: Update README.md inside of src/test/
- [`e34e2bbcc`](https://github.com/farsider350/autx-core/commit/e34e2bbcc) Merge #8432: Make CWallet::fFileBacked private.
- [`9589e2448`](https://github.com/farsider350/autx-core/commit/9589e2448) Merge #8152: [Wallet] Remove CWalletDB* parameter from CWallet::AddToWallet
- [`aa6c37919`](https://github.com/farsider350/autx-core/commit/aa6c37919) Merge #8413: Trivial: pass Consensus::Params& instead of CChainParams& in ContextualCheckBlock
- [`60668fb93`](https://github.com/farsider350/autx-core/commit/60668fb93) Merge #8346: Mempool: Use Consensus::CheckTxInputs direclty over main::CheckInputs
- [`8c76eb739`](https://github.com/farsider350/autx-core/commit/8c76eb739) Merge #8400: [qa]: enable rpcbind_test
- [`eb54680c3`](https://github.com/farsider350/autx-core/commit/eb54680c3) Merge #8238: [WIP][depends] ZeroMQ 4.1.5 && ZMQ on Windows
- [`7c1c9d0ea`](https://github.com/farsider350/autx-core/commit/7c1c9d0ea) Merge #8427: net: Ignore `notfound` P2P messages
- [`13b4e659b`](https://github.com/farsider350/autx-core/commit/13b4e659b) Merge #8274: util: Update tinyformat
- [`c03c42116`](https://github.com/farsider350/autx-core/commit/c03c42116) Merge #8421: httpserver: drop boost (#8023 dependency)
- [`2e4e12f4a`](https://github.com/farsider350/autx-core/commit/2e4e12f4a) Merge #8412: libconsensus: Expose a flag for BIP112
- [`b673b7bf6`](https://github.com/farsider350/autx-core/commit/b673b7bf6) Merge #8321: [trivial] Switched constants to sizeof()
- [`e7da254c5`](https://github.com/farsider350/autx-core/commit/e7da254c5) Merge #8407: [Qt] Add dbcache migration path
- [`150d63f09`](https://github.com/farsider350/autx-core/commit/150d63f09) Merge #8414: prepend license statement to indirectmap.h
- [`04525b435`](https://github.com/farsider350/autx-core/commit/04525b435) Merge #8358: [doc] gbuild: Set memory explicitly (default is too low)
- [`47c726e1d`](https://github.com/farsider350/autx-core/commit/47c726e1d) Merge #8396: remove outdated legacy code from key.h
- [`9a91ddb41`](https://github.com/farsider350/autx-core/commit/9a91ddb41) Merge #8347: Trivial: Make CBlockIndex param const in ContextualCheckBlockHeader and ContextualCheckBlock
- [`0bea37d7b`](https://github.com/farsider350/autx-core/commit/0bea37d7b) Merge #8342: Consensus: Trivial transform BOOST_FOREACH into for loop
- [`8cfc25739`](https://github.com/farsider350/autx-core/commit/8cfc25739) Merge #11847: Make boost::multi_index comparators const
- [`9c2e97085`](https://github.com/farsider350/autx-core/commit/9c2e97085) Fix review nits
- [`f61a75402`](https://github.com/farsider350/autx-core/commit/f61a75402) Disable free transactions in TestPackageSelection
- [`f8a7a2c88`](https://github.com/farsider350/autx-core/commit/f8a7a2c88) Move bitcoin.ico/png and bitcoin_testnet.ico/png one dir up
- [`a9f0aedb3`](https://github.com/farsider350/autx-core/commit/a9f0aedb3) Merge #8320: Fix 0.12 release notes on block relaying
- [`6a993236b`](https://github.com/farsider350/autx-core/commit/6a993236b) Remove SegWit related checks added by backporting of Bitcoin #8295
- [`f9f3b8d93`](https://github.com/farsider350/autx-core/commit/f9f3b8d93) Merge #8295: Mining-related fixups for 0.13.0
- [`bc257c1a0`](https://github.com/farsider350/autx-core/commit/bc257c1a0) Merge #8305: Improve handling of unconnecting headers
- [`26540aa5d`](https://github.com/farsider350/autx-core/commit/26540aa5d) Merge #8289: bash-completion: Adapt for 0.12 and 0.13
- [`167047297`](https://github.com/farsider350/autx-core/commit/167047297) Merge #8314: Fix pkg-config issues for 0.13
- [`e6b071ab0`](https://github.com/farsider350/autx-core/commit/e6b071ab0) Merge #8315: gitian: Don't require sudo for Linux.
- [`237ba56d9`](https://github.com/farsider350/autx-core/commit/237ba56d9) Merge #8303: [Doc] Update bips.md for CSV softfork.
- [`7a6febfaa`](https://github.com/farsider350/autx-core/commit/7a6febfaa) Merge #8310: build: require boost for bench
- [`5ff5474e4`](https://github.com/farsider350/autx-core/commit/5ff5474e4) Merge #8304: [travis] Update SDK_URL
- [`25627e31d`](https://github.com/farsider350/autx-core/commit/25627e31d) Merge #8288: qt: Network-specific example address
- [`355f3724d`](https://github.com/farsider350/autx-core/commit/355f3724d) Merge #8298: wallet: Revert input selection post-pruning
- [`2c914e8ba`](https://github.com/farsider350/autx-core/commit/2c914e8ba) Merge #8280: Tests: Increase sync_blocks() timeouts in pruning.py
- [`dcf36df67`](https://github.com/farsider350/autx-core/commit/dcf36df67) Merge #8285: windows: Add testnet link to installer
- [`ba6b36978`](https://github.com/farsider350/autx-core/commit/ba6b36978) Merge #8281: qt: Remove client name from debug window
- [`17aa23c88`](https://github.com/farsider350/autx-core/commit/17aa23c88) Merge #8261: The bit field is shown only when status is "started"
- [`7f5b8f1e1`](https://github.com/farsider350/autx-core/commit/7f5b8f1e1) Merge #8258: RPC: Hide softfork if timeout is 0
- [`f1f139033`](https://github.com/farsider350/autx-core/commit/f1f139033) Merge #8252: [trivial] Add aarch64 to depends .gitignore
- [`3f7273d00`](https://github.com/farsider350/autx-core/commit/3f7273d00) Merge #8256: BUG: bitcoin-qt crash
- [`5a844dcc4`](https://github.com/farsider350/autx-core/commit/5a844dcc4) Merge #8254: [doc] Add OSX ZMQ requirement to QA readme
- [`b7b5d6ea7`](https://github.com/farsider350/autx-core/commit/b7b5d6ea7) Merge #8246: trivial: capitalize BIP32 in option help
- [`e51f50544`](https://github.com/farsider350/autx-core/commit/e51f50544) Merge #8222: Enable mempool consistency checks in unit tests
- [`381629c75`](https://github.com/farsider350/autx-core/commit/381629c75) Merge #8229: [Doc] Update OS X build notes for 10.11 SDK
- [`e2bcf8ae0`](https://github.com/farsider350/autx-core/commit/e2bcf8ae0) Merge #8216: [qa] assert 'changePosition out of bounds'
- [`c2dabf8bd`](https://github.com/farsider350/autx-core/commit/c2dabf8bd) Merge #8220: Stop trimming when mapTx is empty
- [`36aa55458`](https://github.com/farsider350/autx-core/commit/36aa55458) Temporarily fix build error cased by out-of-order backporting
- [`808936cc3`](https://github.com/farsider350/autx-core/commit/808936cc3) Merge #8179: Evict orphans which are included or precluded by accepted blocks.
- [`573d9314e`](https://github.com/farsider350/autx-core/commit/573d9314e) Merge #7713: Fixes for verify-commits script
- [`d2c3b7efe`](https://github.com/farsider350/autx-core/commit/d2c3b7efe) Merge #7687: Stop treating importaddress'ed scripts as change
- [`782745b05`](https://github.com/farsider350/autx-core/commit/782745b05) Merge #8066: [qa] test_framework: Use different rpc_auth_pair for each node
- [`68757db68`](https://github.com/farsider350/autx-core/commit/68757db68) Merge #8210: [Qt] Bump to Qt5.6.1
- [`05684db6e`](https://github.com/farsider350/autx-core/commit/05684db6e) Merge #8203: Clarify documentation for running a tor node
- [`b6d8206c2`](https://github.com/farsider350/autx-core/commit/b6d8206c2) Merge #8224: readme: Omit phrasing; 'new'
- [`46473757e`](https://github.com/farsider350/autx-core/commit/46473757e) Merge #8215: [wallet] tests: Don't use floating point
- [`6227cfdad`](https://github.com/farsider350/autx-core/commit/6227cfdad) Merge #8214: [qa] mininode: fail on send_message instead of silent return
- [`f362c610e`](https://github.com/farsider350/autx-core/commit/f362c610e) Merge #7600: Mining: Select transactions using feerate-with-ancestors
- [`79ad5f768`](https://github.com/farsider350/autx-core/commit/79ad5f768) Bump univalue version
- [`c783b39ce`](https://github.com/farsider350/autx-core/commit/c783b39ce) Merge #8171: [RPC] Fix createrawtx sequence number unsigned int parsing
- [`402eb5573`](https://github.com/farsider350/autx-core/commit/402eb5573) Merge #8208: Do not set extra flags for unfiltered DNS seed results
- [`9875ab535`](https://github.com/farsider350/autx-core/commit/9875ab535) Merge #8207: [trivial] Add a link to the Bitcoin-Core repository and website to the About Dialog
- [`96180a189`](https://github.com/farsider350/autx-core/commit/96180a189) Merge #7636: Add bitcoin address label to request payment QR code
- [`62852538e`](https://github.com/farsider350/autx-core/commit/62852538e) Merge #8198: [trivial] Sync ax_pthread with upstream draft4
- [`61a667fc4`](https://github.com/farsider350/autx-core/commit/61a667fc4) Merge #8194: [gitian] set correct PATH for wrappers
- [`2b4e896f6`](https://github.com/farsider350/autx-core/commit/2b4e896f6) Merge #8197: [trivial] Ignore split-debug.sh
- [`0c6122634`](https://github.com/farsider350/autx-core/commit/0c6122634) Also revert BLOCK_DOWNLOAD_TIMEOUT_PER_PEER to 500000
- [`c7937c202`](https://github.com/farsider350/autx-core/commit/c7937c202) Remove unnecessary call to AddInventoryKnown in INV message handling
- [`e3ca41b1c`](https://github.com/farsider350/autx-core/commit/e3ca41b1c) autxify build-osx.md
- [`49f9d613b`](https://github.com/farsider350/autx-core/commit/49f9d613b) Revert to BLOCK_DOWNLOAD_TIMEOUT_BASE = 1000000
- [`f00aeb87c`](https://github.com/farsider350/autx-core/commit/f00aeb87c) Fix failing test in p2p-fullblocktest.py
- [`05c8f2ee2`](https://github.com/farsider350/autx-core/commit/05c8f2ee2) autxify new tests in bitcoin-util-test.json
- [`2e51d8273`](https://github.com/farsider350/autx-core/commit/2e51d8273) Merge #8201: [qa] fundrawtransaction: Fix race, assert amounts
- [`e7e3a8071`](https://github.com/farsider350/autx-core/commit/e7e3a8071) Merge #8141: Continuing port of java comparison tool
- [`6a698300a`](https://github.com/farsider350/autx-core/commit/6a698300a) Merge #7598: Refactor CreateNewBlock to be a method of the BlockAssembler class
- [`6ef8aae76`](https://github.com/farsider350/autx-core/commit/6ef8aae76) Merge #8193: [trivial][doc] Use Debian 8.5 in the gitian-build guide
- [`06a73ad7c`](https://github.com/farsider350/autx-core/commit/06a73ad7c) Merge #8188: Add armhf/aarch64 gitian builds
- [`acbda5d16`](https://github.com/farsider350/autx-core/commit/acbda5d16) Merge #8177: developer notes: updates for C++11
- [`b95a338b3`](https://github.com/farsider350/autx-core/commit/b95a338b3) Merge #8133: build: Finish up out-of-tree changes
- [`79db88bbb`](https://github.com/farsider350/autx-core/commit/79db88bbb) Merge #8181: build: Get rid of `CLIENT_DATE`
- [`209a4d63b`](https://github.com/farsider350/autx-core/commit/209a4d63b) Merge #8178: Add git and github tips and tricks to developer notes
- [`b9a00f629`](https://github.com/farsider350/autx-core/commit/b9a00f629) Merge #7292: [RPC] Expose ancestor/descendant information over RPC
- [`856e54678`](https://github.com/farsider350/autx-core/commit/856e54678) Merge #7283: [gitian] Default reference_datetime to commit author date
- [`2e3aacf43`](https://github.com/farsider350/autx-core/commit/2e3aacf43) Merge #8166: src/test: Do not shadow local variables
- [`aa6cb48bf`](https://github.com/farsider350/autx-core/commit/aa6cb48bf) Merge #8154: drop vAddrToSend after sending big addr message
- [`ca228f09f`](https://github.com/farsider350/autx-core/commit/ca228f09f) Merge #8168: util: Add ParseUInt32 and ParseUInt64
- [`cfc76bab9`](https://github.com/farsider350/autx-core/commit/cfc76bab9) Merge #8172: Fix two warnings for comparison between signed and unsigned
- [`a60d4d64c`](https://github.com/farsider350/autx-core/commit/a60d4d64c) Remove 'LDFLAGS=-static-libstdc++' from CONFIGFLAGS in gitian-linux.yml
- [`80d02d8f5`](https://github.com/farsider350/autx-core/commit/80d02d8f5) Use nRelevantServices for requiredServiceBits
- [`b3e26cc75`](https://github.com/farsider350/autx-core/commit/b3e26cc75) Merge #8083: Add support for dnsseeds with option to filter by servicebits
- [`361d26037`](https://github.com/farsider350/autx-core/commit/361d26037) Merge #8173: Use SipHash for node eviction (cont'd)
- [`fc7b5778f`](https://github.com/farsider350/autx-core/commit/fc7b5778f) Merge #7993: [depends] Bump Freetype, ccache, ZeroMQ, miniupnpc, expat
- [`05419aba3`](https://github.com/farsider350/autx-core/commit/05419aba3) Merge #8153: [rpc] fundrawtransaction feeRate: Use BTC/kB
- [`ca699ceba`](https://github.com/farsider350/autx-core/commit/ca699ceba) Merge #8126: std::shared_ptr based CTransaction storage in mempool
- [`51fa05ac3`](https://github.com/farsider350/autx-core/commit/51fa05ac3) Merge #8082: Defer inserting into maprelay until just before relaying.
- [`881d8329c`](https://github.com/farsider350/autx-core/commit/881d8329c) Merge #7703: tor: Change auth order to only use password auth if -torpassword
- [`00c84ca53`](https://github.com/farsider350/autx-core/commit/00c84ca53) Merge #8065: Addrman offline attempts
- [`2ee817fb0`](https://github.com/farsider350/autx-core/commit/2ee817fb0) Merge #8078: Disable the mempool P2P command when bloom filters disabled
- [`0b8169d49`](https://github.com/farsider350/autx-core/commit/0b8169d49) Merge #8164: [Bitcoin-Tx] fix missing test fixtures, fix 32bit atoi issue
- [`9af87c826`](https://github.com/farsider350/autx-core/commit/9af87c826) Merge #7957: [RPC][Bitcoin-TX] Add support for sequence number
- [`d5d25564c`](https://github.com/farsider350/autx-core/commit/d5d25564c) Merge #8136: Log/report in 10% steps during VerifyDB
- [`7f0213ac3`](https://github.com/farsider350/autx-core/commit/7f0213ac3) Merge #8118: Reduce unnecessary hashing in signrawtransaction
- [`49c2e9702`](https://github.com/farsider350/autx-core/commit/49c2e9702) Merge #8151: [init] Make feefilter option debug option
- [`b2bd69a7a`](https://github.com/farsider350/autx-core/commit/b2bd69a7a) Merge #8142: Improve CWallet API  with new GetAccountPubkey function.
- [`463a68d4a`](https://github.com/farsider350/autx-core/commit/463a68d4a) Merge #8007: Minor locking improvements
- [`d7d5d577f`](https://github.com/farsider350/autx-core/commit/d7d5d577f) Merge #8137: Improve CWallet API with new AccountMove function.
- [`7538795b1`](https://github.com/farsider350/autx-core/commit/7538795b1) Merge #8143: comment nit: miners don't vote
- [`c69df9b82`](https://github.com/farsider350/autx-core/commit/c69df9b82) Merge #7967: [RPC] add feerate option to fundrawtransaction
- [`af51e591b`](https://github.com/farsider350/autx-core/commit/af51e591b) Merge #8139: Fix interrupted HTTP RPC connection workaround for Python 3.5+
- [`fb88e9b60`](https://github.com/farsider350/autx-core/commit/fb88e9b60) Merge #7997: replace mapNextTx with slimmer setSpends
- [`df14a7f00`](https://github.com/farsider350/autx-core/commit/df14a7f00) Merge #7825: Prevent multiple calls to ExtractDestination
- [`dbf4dc4de`](https://github.com/farsider350/autx-core/commit/dbf4dc4de) Merge #8029: [Doc] Simplify OS X build notes
- [`fefd0ace3`](https://github.com/farsider350/autx-core/commit/fefd0ace3) Merge #8077: Consensus: Decouple from chainparams.o and timedata.o
- [`bf069fb1b`](https://github.com/farsider350/autx-core/commit/bf069fb1b) Merge #8123: Use std::atomic for fRequestShutdown and fReopenDebugLog
- [`09eda9783`](https://github.com/farsider350/autx-core/commit/09eda9783) Merge #8112: Include signal.h for sig_atomic_t in WIN32
- [`bad08eadf`](https://github.com/farsider350/autx-core/commit/bad08eadf) Merge #7960: Only use AddInventoryKnown for transactions
- [`433a026a1`](https://github.com/farsider350/autx-core/commit/433a026a1) Fix OpenSSL build error
- [`91752ab7e`](https://github.com/farsider350/autx-core/commit/91752ab7e) Merge #7689: Replace OpenSSL AES with ctaes-based version
- [`83dc1dc99`](https://github.com/farsider350/autx-core/commit/83dc1dc99) Directly push messages instead of using CDataStream first
- [`e65bf228b`](https://github.com/farsider350/autx-core/commit/e65bf228b) Merge #8121: [Doc] Update implemented BIPs list
- [`dfa0bd234`](https://github.com/farsider350/autx-core/commit/dfa0bd234) Merge #8080: Do not use mempool for GETDATA for tx accepted after the last mempool req.
- [`b2a27c062`](https://github.com/farsider350/autx-core/commit/b2a27c062) Only serve normal transactions from mapRelay
- [`bef036125`](https://github.com/farsider350/autx-core/commit/bef036125) Merge #7877: Change mapRelay to store CTransactions
- [`2dc71e8e0`](https://github.com/farsider350/autx-core/commit/2dc71e8e0) Revert deadlock fix in ProcessGetData
- [`d8c5a5900`](https://github.com/farsider350/autx-core/commit/d8c5a5900) Merge #8090: Adding P2SH(p2pkh) script test case
- [`34b7fddde`](https://github.com/farsider350/autx-core/commit/34b7fddde) autxify benchmarking.md binary name
- [`475dbd49b`](https://github.com/farsider350/autx-core/commit/475dbd49b) Pass sys.stdout to Popen instead of subprocess.STDOUT
- [`a0481f1ed`](https://github.com/farsider350/autx-core/commit/a0481f1ed) Merge #8750: [qa] Refactor RPCTestHandler to prevent TimeoutExpired
- [`5496e468a`](https://github.com/farsider350/autx-core/commit/5496e468a) autxify a few docs and the use of an address
- [`5ba21d4e3`](https://github.com/farsider350/autx-core/commit/5ba21d4e3) Revert "ReprocessBlocks"->"ResetBlockFailureFlags" in debug message
- [`b1df5e9e8`](https://github.com/farsider350/autx-core/commit/b1df5e9e8) Align sorting in OverviewPage::SetupTransactionList with transaction view
- [`abe84cb9e`](https://github.com/farsider350/autx-core/commit/abe84cb9e) Use GetStrongRandBytes in CMnemonic::Generate
- [`249167ab8`](https://github.com/farsider350/autx-core/commit/249167ab8) Python 3 in .travis.yml
- [`a1111cdf6`](https://github.com/farsider350/autx-core/commit/a1111cdf6) autxify addresses/keys in signmessages.py RPC test
- [`21aaf9289`](https://github.com/farsider350/autx-core/commit/21aaf9289) Introduce redirect_stderr argument to start_node
- [`fbe36d3db`](https://github.com/farsider350/autx-core/commit/fbe36d3db) Pass -createwalletbackups=0 to autxd when running rpc tests
- [`69dd8f4a6`](https://github.com/farsider350/autx-core/commit/69dd8f4a6) Python 3 fixes/porting in rpc tests
- [`2924b3440`](https://github.com/farsider350/autx-core/commit/2924b3440) Cast command to str when calling show_debug_msg
- [`6dc4a1385`](https://github.com/farsider350/autx-core/commit/6dc4a1385) Merge #8110: [Doc] Add benchmarking notes
- [`a3c63033d`](https://github.com/farsider350/autx-core/commit/a3c63033d) Merge #8115: Avoid integer division in the benchmark inner-most loop.
- [`43cbeb7fa`](https://github.com/farsider350/autx-core/commit/43cbeb7fa) Merge #7891: Always require OS randomness when generating secret keys
- [`cee571bda`](https://github.com/farsider350/autx-core/commit/cee571bda) Merge #8107: bench: Added base58 encoding/decoding benchmarks
- [`a39b1f7b8`](https://github.com/farsider350/autx-core/commit/a39b1f7b8) Merge #7896: fix typo in help text
- [`6c962f5e6`](https://github.com/farsider350/autx-core/commit/6c962f5e6) Merge #8111: Benchmark SipHash
- [`0027292ac`](https://github.com/farsider350/autx-core/commit/0027292ac) Merge #8104: Tests: add timeout to sync_blocks() and sync_mempools()
- [`8d47ecb23`](https://github.com/farsider350/autx-core/commit/8d47ecb23) Merge #8108: Trivial: Remove unused local variable shadowing upper local
- [`7db5be442`](https://github.com/farsider350/autx-core/commit/7db5be442) Merge #8098: [qa] test_framework: Append portseed to tmpdir
- [`b71ee087a`](https://github.com/farsider350/autx-core/commit/b71ee087a) Merge #8015: CCoinsViewErrorCatcher raison-d-etre
- [`9bf698793`](https://github.com/farsider350/autx-core/commit/9bf698793) Merge #8034: [doc][trivial] Add basic git squash workflow [skip ci]
- [`640bee181`](https://github.com/farsider350/autx-core/commit/640bee181) Merge #7795: UpdateTip: log only one line at most per block
- [`51d17dcde`](https://github.com/farsider350/autx-core/commit/51d17dcde) Move AutoBackupWallet into wallet.cpp
- [`8723f9956`](https://github.com/farsider350/autx-core/commit/8723f9956) Merge #8061: [Wallet] Improve Wallet encapsulation
- [`c571a9490`](https://github.com/farsider350/autx-core/commit/c571a9490) Merge #8076: VerifyDB: don't check blocks that have been pruned
- [`42a3e0d2d`](https://github.com/farsider350/autx-core/commit/42a3e0d2d) Merge #8063: Acquire lock to check for genesis block.
- [`00bf61885`](https://github.com/farsider350/autx-core/commit/00bf61885) Merge #8092: Correct small typo in extract_strings_qt.py
- [`f50b8bf66`](https://github.com/farsider350/autx-core/commit/f50b8bf66) Merge #8095: Test framework: only cleanup on successful test runs
- [`3f5be563f`](https://github.com/farsider350/autx-core/commit/3f5be563f) Merge #8014: Qt: Sort transactions by date
- [`62aaaaeac`](https://github.com/farsider350/autx-core/commit/62aaaaeac) Merge #8047: [qa] test_framework: Set wait-timeout for bitcoind procs
- [`bcecdcd8e`](https://github.com/farsider350/autx-core/commit/bcecdcd8e) Merge #8056: [qa] Remove hardcoded "4 nodes" from test_framework
- [`8eeaa4f21`](https://github.com/farsider350/autx-core/commit/8eeaa4f21) Fix typo adddrman to addrman as requested in #8070
- [`1897ccc64`](https://github.com/farsider350/autx-core/commit/1897ccc64) Merge #8033: Fix Socks5() connect failures to be less noisy and less unnecessarily scary
- [`0450dfdeb`](https://github.com/farsider350/autx-core/commit/0450dfdeb) Merge #7932: CAddrMan::Deserialize handle corrupt serializations better.
- [`72bee9e55`](https://github.com/farsider350/autx-core/commit/72bee9e55) Merge #8031: improvement to readability
- [`8b28f5f99`](https://github.com/farsider350/autx-core/commit/8b28f5f99) Merge #8020: Use SipHash-2-4 for various non-cryptographic hashes
- [`a0afc3ee0`](https://github.com/farsider350/autx-core/commit/a0afc3ee0) Merge #8038: [qa, doc] Various minor fixes
- [`7b2587946`](https://github.com/farsider350/autx-core/commit/7b2587946) Merge #8059: Remove unneeded feerate param from RelayTransaction/AcceptToMemoryPool.
- [`26f07f835`](https://github.com/farsider350/autx-core/commit/26f07f835) Merge #8004: signal handling: fReopenDebugLog and fRequestShutdown should be type sig_atomic_t
- [`f0fe21d37`](https://github.com/farsider350/autx-core/commit/f0fe21d37) Merge #8041: [qa] Fix bip9-softforks blockstore issue
- [`4ee385842`](https://github.com/farsider350/autx-core/commit/4ee385842) Merge #8039: bench: Add crypto hash benchmarks
- [`f1996dc8c`](https://github.com/farsider350/autx-core/commit/f1996dc8c) Merge #7972:  [qa] pull-tester: Run rpc test in parallel
- [`76b72a7f2`](https://github.com/farsider350/autx-core/commit/76b72a7f2) Merge #8028: Fix insanity of CWalletDB::WriteTx and CWalletTx::WriteToDisk
- [`4750be1af`](https://github.com/farsider350/autx-core/commit/4750be1af) Merge #8036: init: Move berkeleydb version reporting to wallet
- [`3dbae2d32`](https://github.com/farsider350/autx-core/commit/3dbae2d32) Merge #8019: Remove state arg from ReconsiderBlock, rename to ResetBlockFailureFlags
- [`262e857db`](https://github.com/farsider350/autx-core/commit/262e857db) Merge #8012: Qt: Delay user confirmation of send
- [`8bafa06b7`](https://github.com/farsider350/autx-core/commit/8bafa06b7) Merge #7971: [qa] Refactor test_framework and pull tester
- [`24ff34102`](https://github.com/farsider350/autx-core/commit/24ff34102) Merge #8018: Autofind rpc tests --srcdir
- [`19a6c779e`](https://github.com/farsider350/autx-core/commit/19a6c779e) Merge #8030: test: Revert fatal-ness of missing python-zmq
- [`3d665aa48`](https://github.com/farsider350/autx-core/commit/3d665aa48) Use fThread = true default argument in CAlert::Notify
- [`3110f7ebd`](https://github.com/farsider350/autx-core/commit/3110f7ebd) Fix issues introduced in 1770 (#1803)
- [`5222e9377`](https://github.com/farsider350/autx-core/commit/5222e9377) Merge #7976: Remove obsolete reference to CValidationState from UpdateCoins.
- [`93be53e34`](https://github.com/farsider350/autx-core/commit/93be53e34) Merge #7934: Improve rolling bloom filter performance and benchmark
- [`65a71dcb2`](https://github.com/farsider350/autx-core/commit/65a71dcb2) Merge #8009: Docs: Fixed invalid example paths in gitian-building.md
- [`19af9cfe1`](https://github.com/farsider350/autx-core/commit/19af9cfe1) Merge #8013: doc: Fedora build requirements, add gcc-c++ and fix typo
- [`25147c9dc`](https://github.com/farsider350/autx-core/commit/25147c9dc) Merge #7814: [qa] Switch to py3
- [`c66fcf47e`](https://github.com/farsider350/autx-core/commit/c66fcf47e) Merge #8011: don't run ThreadMessageHandler at lowered priority
- [`d4b8abf4f`](https://github.com/farsider350/autx-core/commit/d4b8abf4f) Send non-tx/non-block inventory items
- [`5d8e94a26`](https://github.com/farsider350/autx-core/commit/5d8e94a26) Merge #7840: Several performance and privacy improvements to inv/mempool handling
- [`33233409a`](https://github.com/farsider350/autx-core/commit/33233409a) Merge #7966: http: Do a pending c++11 simplification handling work items
- [`90b00cfc6`](https://github.com/farsider350/autx-core/commit/90b00cfc6) Merge #7953: Create signmessagewithprivkey rpc
- [`233493b71`](https://github.com/farsider350/autx-core/commit/233493b71) Delete old "autx" registry key when installing/uninstalling
- [`b78bd5cc7`](https://github.com/farsider350/autx-core/commit/b78bd5cc7) autxify help text of fundrawtransaction
- [`da2de0771`](https://github.com/farsider350/autx-core/commit/da2de0771) Put ps_rounds to the bottom of the result of listunspent
- [`15fc7f213`](https://github.com/farsider350/autx-core/commit/15fc7f213) De-bump fees in miner_tests.cpp
- [`7d4046186`](https://github.com/farsider350/autx-core/commit/7d4046186) Fix failing fundrawtransaction tests
- [`2c63839f2`](https://github.com/farsider350/autx-core/commit/2c63839f2) autxify fundrawtransaction exception
- [`f8ad2ffa7`](https://github.com/farsider350/autx-core/commit/f8ad2ffa7) Merge #7977: [trivial] Add missing const qualifiers.
- [`e6b2f918d`](https://github.com/farsider350/autx-core/commit/e6b2f918d) Merge #7968: doc: Fedora build requirements
- [`79fe8e45f`](https://github.com/farsider350/autx-core/commit/79fe8e45f) Merge #8002: [depends] Add -stdlib=libc++ to darwin CXX flags
- [`d55b78eb6`](https://github.com/farsider350/autx-core/commit/d55b78eb6) Merge #8000: tinyformat: force USE_VARIADIC_TEMPLATES
- [`49c3127b5`](https://github.com/farsider350/autx-core/commit/49c3127b5) Merge #7974: More comments on the design of AttemptToEvictConnection.
- [`9bed9ac9f`](https://github.com/farsider350/autx-core/commit/9bed9ac9f) Merge #7975: [doc] Update bitcoin-core GitHub links
- [`6662e23a0`](https://github.com/farsider350/autx-core/commit/6662e23a0) Merge #7982: build: No need to check for leveldb atomics
- [`7c6dab037`](https://github.com/farsider350/autx-core/commit/7c6dab037) Return from main instead of calling exit()
- [`a468803bd`](https://github.com/farsider350/autx-core/commit/a468803bd) Merge #7964: Minor changes for c++11 consistency
- [`d97501316`](https://github.com/farsider350/autx-core/commit/d97501316) Merge #7807: Fixed miner test values, gave constants for less error-prone values.
- [`61227bb21`](https://github.com/farsider350/autx-core/commit/61227bb21) Merge #7962: CalculateNextWorkRequired Cleanup
- [`03507a720`](https://github.com/farsider350/autx-core/commit/03507a720) Merge #7952: Log invalid block hash to make debugging easier.
- [`c8bb792f4`](https://github.com/farsider350/autx-core/commit/c8bb792f4) Merge #7939: qt: Make it possible to show details for multiple transactions
- [`d69bcb1a0`](https://github.com/farsider350/autx-core/commit/d69bcb1a0) Merge #7941: Fixing comment in script_test.json test case
- [`7973142f1`](https://github.com/farsider350/autx-core/commit/7973142f1) Reformat listunstpent help to align with upstream
- [`5cf744532`](https://github.com/farsider350/autx-core/commit/5cf744532) Merge #7916: Explicitly pass CChainParams& to DisconnectTip()
- [`a60c35182`](https://github.com/farsider350/autx-core/commit/a60c35182) Error/Warning fixes for HD wallet part in wallet.cpp
- [`bacc86464`](https://github.com/farsider350/autx-core/commit/bacc86464) Merge #7787: [Moveonly] Create ui_interface.cpp
- [`c3e590968`](https://github.com/farsider350/autx-core/commit/c3e590968) Add missing parts from bitcoin PR #7762
- [`8678f2b39`](https://github.com/farsider350/autx-core/commit/8678f2b39) Merge #7905: test: move accounting_tests and rpc_wallet_tests to wallet/test
- [`4f5bb798e`](https://github.com/farsider350/autx-core/commit/4f5bb798e) Merge #7827: Speed up getchaintips.
- [`1b17e94ee`](https://github.com/farsider350/autx-core/commit/1b17e94ee) Merge #7900: fix spelling mistake
- [`96f9a7c3e`](https://github.com/farsider350/autx-core/commit/96f9a7c3e) Merge #7897: add missing newline
- [`cfb8b82dc`](https://github.com/farsider350/autx-core/commit/cfb8b82dc) Merge #7848: Divergence between 32- and 64-bit when hashing >4GB affects `gettxoutsetinfo`
- [`c172273e4`](https://github.com/farsider350/autx-core/commit/c172273e4) autxify new binary name variables
- [`9bd55b1bf`](https://github.com/farsider350/autx-core/commit/9bd55b1bf) Merge #7603: Build System: Use PACKAGE_TARNAME in NSIS script
- [`6c7d13380`](https://github.com/farsider350/autx-core/commit/6c7d13380) Merge #7518: Add multiple options to fundrawtransaction
- [`f1197476a`](https://github.com/farsider350/autx-core/commit/f1197476a) Merge #7870: [contrib] Add MarcoFalke key and move all keys to contrib/gitian-keys
- [`24f8c248f`](https://github.com/farsider350/autx-core/commit/24f8c248f) Merge #7856: Only send one GetAddr response per connection.
- [`b2eabb097`](https://github.com/farsider350/autx-core/commit/b2eabb097) Merge #7809: depends: some base fixes/changes
- [`60159eb2f`](https://github.com/farsider350/autx-core/commit/60159eb2f) Merge #7798: [travis] Print the commit which was evaluated
- [`d532f22d3`](https://github.com/farsider350/autx-core/commit/d532f22d3) Use BIP32_EXTKEY_SIZE instead of fixed constant
- [`7080c27dd`](https://github.com/farsider350/autx-core/commit/7080c27dd) Merge #7878: [test] bctest.py: Revert faa41ee
- [`ac53190bf`](https://github.com/farsider350/autx-core/commit/ac53190bf) Add missing changes from Bitcoin #7853
- [`c176f6c5b`](https://github.com/farsider350/autx-core/commit/c176f6c5b) Merge #7812: Tiny refactor of `IsRBFOptIn`, avoid exception
- [`f1f3fa327`](https://github.com/farsider350/autx-core/commit/f1f3fa327) Merge #7846: Clean up lockorder data of destroyed mutexes
- [`116b14b5f`](https://github.com/farsider350/autx-core/commit/116b14b5f) Merge #7849: tests: add varints_bitpatterns test
- [`1ac85586c`](https://github.com/farsider350/autx-core/commit/1ac85586c) Merge #7847: doc: add arch linux build example
- [`cc3a06bf5`](https://github.com/farsider350/autx-core/commit/cc3a06bf5) Merge #7863: getblockchaininfo: make bip9_softforks an object, not an array.
- [`5b1ad12d1`](https://github.com/farsider350/autx-core/commit/5b1ad12d1) Merge #7855: [doc] gitian: Replace precise with trusty
- [`20cb9aa21`](https://github.com/farsider350/autx-core/commit/20cb9aa21) Merge #7796: [amount] Add support for negative fee rates
- [`e48f46c80`](https://github.com/farsider350/autx-core/commit/e48f46c80) Merge #7838: [Doc] Update gitian build guide to debian 8.4.0
- [`d983f1d78`](https://github.com/farsider350/autx-core/commit/d983f1d78) Merge #7828: Trivial: Globals: Explicitly pass const CChainParams& to ProcessMessage()
- [`2a7971010`](https://github.com/farsider350/autx-core/commit/2a7971010) Merge #7786: Doc: Update isStandardTx comment
- [`b2d659f19`](https://github.com/farsider350/autx-core/commit/b2d659f19) Merge #7570: Net: Add IPv6 Link-Local Address Support
- [`a8aeff143`](https://github.com/farsider350/autx-core/commit/a8aeff143) Merge #7801: [qa] Remove misleading "errorString syntax"
- [`738e1c51c`](https://github.com/farsider350/autx-core/commit/738e1c51c) Merge #7793: [doxygen] Fix member comments
- [`1f8ca7546`](https://github.com/farsider350/autx-core/commit/1f8ca7546) depends: mac deploy Py3 compatibility
- [`e5b82075a`](https://github.com/farsider350/autx-core/commit/e5b82075a) Fix no-wallet build after backports refactored RPCs
- [`f235b6a6a`](https://github.com/farsider350/autx-core/commit/f235b6a6a) Apply review suggestions/fixes
- [`6a515e5e2`](https://github.com/farsider350/autx-core/commit/6a515e5e2) Merge #7788: Use relative paths instead of absolute paths in protoc calls
- [`d5f1b5ae8`](https://github.com/farsider350/autx-core/commit/d5f1b5ae8) Merge #7791: Doc: change Precise to Trusty in gitian-building.md
- [`e7d9ffa5d`](https://github.com/farsider350/autx-core/commit/e7d9ffa5d) Merge #7774: RPC: add versionHex in getblock and getblockheader JSON results
- [`1cd653cc5`](https://github.com/farsider350/autx-core/commit/1cd653cc5) Merge #7781: devtools: Auto-set branch to merge to in github-merge
- [`c86717a59`](https://github.com/farsider350/autx-core/commit/c86717a59) Merge #7813: [doc] Update port in tor.md
- [`7ba8612b5`](https://github.com/farsider350/autx-core/commit/7ba8612b5) Merge #7797: RPC: fix generatetoaddress failing to parse address
- [`a7514a8e6`](https://github.com/farsider350/autx-core/commit/a7514a8e6) Merge #7789: [Doc] Add note about using the Qt official binary installer.
- [`9dbda86cb`](https://github.com/farsider350/autx-core/commit/9dbda86cb) HDWallet error/warning message fixes
- [`298224b3b`](https://github.com/farsider350/autx-core/commit/298224b3b) Merge #7691: [Wallet] refactor wallet/init interaction
- [`a5505e7e8`](https://github.com/farsider350/autx-core/commit/a5505e7e8) Merge #7711: [build-aux] Update Boost & check macros to latest serials
- [`21b23d1ec`](https://github.com/farsider350/autx-core/commit/21b23d1ec) Merge #7785: Trivial: Fix typo: Optimizaton -> Optimization [skip ci]
- [`960cb014d`](https://github.com/farsider350/autx-core/commit/960cb014d) Merge #7477: Fix quoting of copyright holders in configure.ac.
- [`0956f3d67`](https://github.com/farsider350/autx-core/commit/0956f3d67) Merge #7763: Put hex-encoded version in UpdateTip
- [`644240157`](https://github.com/farsider350/autx-core/commit/644240157) Merge #7766: rpc: Register calls where they are defined
- [`18da34e29`](https://github.com/farsider350/autx-core/commit/18da34e29) Merge #7761: [Qt] remove trailing output-index from transaction-id
- [`1c8441778`](https://github.com/farsider350/autx-core/commit/1c8441778) Merge #7573: P2P: add maxtimeadjustment command line option
- [`a9a209f58`](https://github.com/farsider350/autx-core/commit/a9a209f58) Merge #7723: build: python 3 compatibility
- [`ba65eb1ac`](https://github.com/farsider350/autx-core/commit/ba65eb1ac) Merge #7764: [qa] Don't run pruning.py twice
- [`a309bf372`](https://github.com/farsider350/autx-core/commit/a309bf372) Clear setInternalKeyPool and setExternalKeyPool instead of setKeyPool
- [`e2fefa539`](https://github.com/farsider350/autx-core/commit/e2fefa539) Merge #7558: [RPC] Add import/removeprunedfunds rpc call
- [`ca33635ef`](https://github.com/farsider350/autx-core/commit/ca33635ef) Merge #7742: [Wallet][RPC] add missing abandon status documentation
- [`34701da5c`](https://github.com/farsider350/autx-core/commit/34701da5c) Merge #7737: devtools: make github-merge.py use py3
- [`a4911c383`](https://github.com/farsider350/autx-core/commit/a4911c383) Merge #7646: Fix lockunspent help message
- [`f933c6726`](https://github.com/farsider350/autx-core/commit/f933c6726) Merge #7715: Fix calculation of balances and available coins.
- [`760d58e3d`](https://github.com/farsider350/autx-core/commit/760d58e3d) Merge #7671: [RPC] Add generatetoaddress rpc to mine to an address
- [`953aeead1`](https://github.com/farsider350/autx-core/commit/953aeead1) Merge #7710: [Depends] Bump miniupnpc and config.guess+sub
- [`74fe8fe59`](https://github.com/farsider350/autx-core/commit/74fe8fe59) Merge #7649: Prevent multiple calls to CWallet::AvailableCoins
- [`aa584522d`](https://github.com/farsider350/autx-core/commit/aa584522d) autx related changes for feefilter
- [`11ac70af9`](https://github.com/farsider350/autx-core/commit/11ac70af9) Merge #7542: Implement "feefilter" P2P message
- [`283922243`](https://github.com/farsider350/autx-core/commit/283922243) Merge #7726: Correct importaddress help reference to importpubkey
- [`04bf554ab`](https://github.com/farsider350/autx-core/commit/04bf554ab) Merge #7712: Improve COutPoint less operator
- [`f4d30a645`](https://github.com/farsider350/autx-core/commit/f4d30a645) Merge #7708: De-neuter NODE_BLOOM
- [`8fde2fd5f`](https://github.com/farsider350/autx-core/commit/8fde2fd5f) Merge #7705: [amount] Add tests and make GetFee() monotonic
- [`721171ee3`](https://github.com/farsider350/autx-core/commit/721171ee3) Merge #7686: [qt] Remove 0-fee from send dialog
- [`29d263389`](https://github.com/farsider350/autx-core/commit/29d263389) Merge #7594: Mempool: Add tracking of ancestor packages
- [`49a8ed6d3`](https://github.com/farsider350/autx-core/commit/49a8ed6d3) Merge #7683: Fix torcontrol.cpp unused private field warning
- [`abbbe61d0`](https://github.com/farsider350/autx-core/commit/abbbe61d0) Merge #7608: [wallet] Move hardcoded file name out of log messages
- [`5f9bfa0b6`](https://github.com/farsider350/autx-core/commit/5f9bfa0b6) Merge #7670: use cached block hash in blockToJSON()
- [`fb4ec255c`](https://github.com/farsider350/autx-core/commit/fb4ec255c) Merge #7663: Make the generate RPC call function for non-regtest
- [`fa0341115`](https://github.com/farsider350/autx-core/commit/fa0341115) Merge #7507: Remove internal miner
- [`332fbfc0e`](https://github.com/farsider350/autx-core/commit/332fbfc0e) HDWallet fixes after moving wallet initialization
- [`b3525b2e6`](https://github.com/farsider350/autx-core/commit/b3525b2e6) Merge #7577: [Wallet] move "load wallet phase" to CWallet
- [`8be396a3b`](https://github.com/farsider350/autx-core/commit/8be396a3b) Merge #7667: Move GetTempPath() to testutil
- [`f1e95e358`](https://github.com/farsider350/autx-core/commit/f1e95e358) Merge #7635: [Documentation] Add dependency info to test docs
- [`51c6ab20f`](https://github.com/farsider350/autx-core/commit/51c6ab20f) Merge #7576: [Wallet] move wallet help string creation to CWallet
- [`24cf36972`](https://github.com/farsider350/autx-core/commit/24cf36972) Merge #7592: mempool: Re-remove ERROR logging for mempool rejects
- [`23eeaeef8`](https://github.com/farsider350/autx-core/commit/23eeaeef8) Merge #7662: remove unused NOBLKS_VERSION_{START,END} constants
- [`00d42b7c9`](https://github.com/farsider350/autx-core/commit/00d42b7c9) Merge #7539: Add tags to mempool's mapTx indices
- [`d6a0de72a`](https://github.com/farsider350/autx-core/commit/d6a0de72a) fix splashscreen (shrink titleCopyrightVSpace)
- [`af5aece96`](https://github.com/farsider350/autx-core/commit/af5aece96) make CopyrightHolders more generic
- [`4e0bb527d`](https://github.com/farsider350/autx-core/commit/4e0bb527d) Merge #8373: Fix OSX non-deterministic dmg
- [`51ca0d5b4`](https://github.com/farsider350/autx-core/commit/51ca0d5b4) Move privatesend to rpcwallet.cpp as well after Bitcoin #7307 was backported
- [`02785c858`](https://github.com/farsider350/autx-core/commit/02785c858) Disable check-doc.py for now until all backported PRs are merged and docs fixed
- [`48eddeea2`](https://github.com/farsider350/autx-core/commit/48eddeea2) Merge #7455: [travis] Exit early when check-doc.py fails
- [`07338feae`](https://github.com/farsider350/autx-core/commit/07338feae) Merge #7620: [travis] Only run check-doc.py once
- [`266520ced`](https://github.com/farsider350/autx-core/commit/266520ced) Merge #7632: Delete outdated test-patches reference
- [`eed9428d2`](https://github.com/farsider350/autx-core/commit/eed9428d2) Merge #7616:  [depends] Delete unused patches
- [`74eda8759`](https://github.com/farsider350/autx-core/commit/74eda8759) Merge #7537: wallet: Warn on unexpected EOF while salvaging wallet
- [`5390a1a0a`](https://github.com/farsider350/autx-core/commit/5390a1a0a) Merge #7590: Improving wording related to Boost library requirements [updated]
- [`f0300c6c5`](https://github.com/farsider350/autx-core/commit/f0300c6c5) Merge #7606: [depends] builders: No need to set -L and --location for curl
- [`a890c7616`](https://github.com/farsider350/autx-core/commit/a890c7616) Merge #7612: [doc] Typo fix
- [`984dc5271`](https://github.com/farsider350/autx-core/commit/984dc5271) Merge #7619: Add missing sudo entry in gitian VM setup.
- [`6a121275d`](https://github.com/farsider350/autx-core/commit/6a121275d) Merge #7583: [doc] Fix typos
- [`97c7da4b7`](https://github.com/farsider350/autx-core/commit/97c7da4b7) Merge #7509: Common argument defaults for NODE_BLOOM stuff and -wallet
- [`ee5f8d211`](https://github.com/farsider350/autx-core/commit/ee5f8d211) Merge #7536: test: test leading spaces for ParseHex
- [`cd7a2e2b5`](https://github.com/farsider350/autx-core/commit/cd7a2e2b5) Merge #7504: Crystal clean make clean
- [`529e8ad63`](https://github.com/farsider350/autx-core/commit/529e8ad63) Merge #7528: autogen.sh: warn about needing autoconf if autoreconf is not found
- [`de91ef95f`](https://github.com/farsider350/autx-core/commit/de91ef95f) Merge #7490: tests: Remove May15 test
- [`7ec1e1887`](https://github.com/farsider350/autx-core/commit/7ec1e1887) Merge #7459: Consensus: Decouple pow.o from util.o
- [`8874b2e0f`](https://github.com/farsider350/autx-core/commit/8874b2e0f) Merge #6480: include the chaintip blockindex in the SyncTransaction signal, add signal UpdateTip()
- [`a3d1e5eda`](https://github.com/farsider350/autx-core/commit/a3d1e5eda) Merge #7070: Move maxTxFee out of mempool
- [`e7a6f79e5`](https://github.com/farsider350/autx-core/commit/e7a6f79e5) Merge #7192: Unify product name to as few places as possible
- [`0f8ce5688`](https://github.com/farsider350/autx-core/commit/0f8ce5688) Merge #7444: Improve block validity/ConnectBlock() comments
- [`bcbd2cda2`](https://github.com/farsider350/autx-core/commit/bcbd2cda2) Merge #7091: Consensus build package
- [`0afbd1c3d`](https://github.com/farsider350/autx-core/commit/0afbd1c3d) Merge #7084: mempool: Replace maxFeeRate of 10000*minRelayTxFee with maxTxFee
- [`a65f7b7a7`](https://github.com/farsider350/autx-core/commit/a65f7b7a7) Merge #7311: MOVEONLY: Move non-consensus functions out of pow
- [`c8e04d43f`](https://github.com/farsider350/autx-core/commit/c8e04d43f) Add missing comment in net.cpp
- [`5f68e06a0`](https://github.com/farsider350/autx-core/commit/5f68e06a0) Add missing whitelistalwaysrelay arg to SET_DOC_OPTIONAL
- [`6789bf6e1`](https://github.com/farsider350/autx-core/commit/6789bf6e1) Merge #7287: Consensus: Remove calls to error() and FormatStateMessage()
- [`3cd83db0d`](https://github.com/farsider350/autx-core/commit/3cd83db0d) Merge #7441: Use Debian 8.3 in gitian build guide
- [`c5f84c4e6`](https://github.com/farsider350/autx-core/commit/c5f84c4e6) Merge #6842: limitfreerelay edge case bugfix
- [`6c5286aad`](https://github.com/farsider350/autx-core/commit/6c5286aad) Merge #7423: doc: add example for building with constrained resources
- [`2fd5d93a9`](https://github.com/farsider350/autx-core/commit/2fd5d93a9) Merge #7437: GUI: Disable tab navigation for peers tables.
- [`b277eed58`](https://github.com/farsider350/autx-core/commit/b277eed58) Merge #7425: devtools: Fix utf-8 support in messages for github-merge
- [`5323a08af`](https://github.com/farsider350/autx-core/commit/5323a08af) Merge #7300: [trivial] Add missing copyright headers
- [`577f683c5`](https://github.com/farsider350/autx-core/commit/577f683c5) Merge #7402: [devtools] github-merge get toplevel dir without extra whitespace
- [`d9d9e95e4`](https://github.com/farsider350/autx-core/commit/d9d9e95e4) Merge #7395: devtools: show pull and commit information in github-merge
- [`85919332d`](https://github.com/farsider350/autx-core/commit/85919332d) Merge #7236: Use createrawtx locktime parm in txn_clone
- [`643181fe1`](https://github.com/farsider350/autx-core/commit/643181fe1) Merge #7262: Reduce inefficiency of GetAccountAddress()
- [`43700eef3`](https://github.com/farsider350/autx-core/commit/43700eef3) Merge #7383: [Qt] rename "amount" to "requested amount" in receive coins table
- [`59db2fda1`](https://github.com/farsider350/autx-core/commit/59db2fda1) Merge #7183: Improved readability of ApproximateBestSubset
- [`78ad32d10`](https://github.com/farsider350/autx-core/commit/78ad32d10) Merge #7307: [RPC, Wallet] Move RPC dispatch table registration to wallet/ code
- [`3be77849d`](https://github.com/farsider350/autx-core/commit/3be77849d) Merge pull request #7378
- [`42997ee8d`](https://github.com/farsider350/autx-core/commit/42997ee8d) Merge pull request #7280
- [`2474fd0ae`](https://github.com/farsider350/autx-core/commit/2474fd0ae) Merge pull request #7208
- [`723eacf45`](https://github.com/farsider350/autx-core/commit/723eacf45) Merge pull request #7290
- [`25ba3aba1`](https://github.com/farsider350/autx-core/commit/25ba3aba1) Merge pull request #7304
- [`38080259b`](https://github.com/farsider350/autx-core/commit/38080259b) Merge pull request #7313
- [`26a5dfe33`](https://github.com/farsider350/autx-core/commit/26a5dfe33) Merge pull request #7326
- [`5ca9b1a9c`](https://github.com/farsider350/autx-core/commit/5ca9b1a9c) Merge pull request #7317
- [`bcebc7c4c`](https://github.com/farsider350/autx-core/commit/bcebc7c4c) Merge pull request #7266
- [`f04f8c19d`](https://github.com/farsider350/autx-core/commit/f04f8c19d) Merge pull request #7257
- [`3f6d6572f`](https://github.com/farsider350/autx-core/commit/3f6d6572f) Merge pull request #7156
- [`bf688abce`](https://github.com/farsider350/autx-core/commit/bf688abce) Merge pull request #7113
- [`f1da40c87`](https://github.com/farsider350/autx-core/commit/f1da40c87) Merge #7550: rpc: Input-from-stdin mode for bitcoin-cli
- [`f8407083c`](https://github.com/farsider350/autx-core/commit/f8407083c) Remove duplicated CCACHE= line in depends/config.site.in
