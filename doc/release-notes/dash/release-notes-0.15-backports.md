...
- [`595826ad6`](https://github.com/farsider350/autx-core/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`2e980018c`](https://github.com/farsider350/autx-core/commit/2e980018c) Merge #11568: Disconnect outbound peers on invalid chains
...
- [`a88e000fe`](https://github.com/farsider350/autx-core/commit/a88e000fe) Merge #11247: qt: Use IsMine to validate custom change address
...
- [`8ba042b58`](https://github.com/farsider350/autx-core/commit/8ba042b58) Fix dip3-deterministicmns.py
...
- [`3d445628a`](https://github.com/farsider350/autx-core/commit/3d445628a) remove     `LogPrintf("Initializing databases...\n");`
...
- [`3e483659a`](https://github.com/farsider350/autx-core/commit/3e483659a) Merge #10914: Add missing lock in CScheduler::AreThreadsServicingQueue()
...
- [`2e235b4b4`](https://github.com/farsider350/autx-core/commit/2e235b4b4) Fix rpcs
...
- [`bfa64fd15`](https://github.com/farsider350/autx-core/commit/bfa64fd15) Merge #10284: Always log debug information for fee calculation in CreateTransaction
...
- [`83af2d8d5`](https://github.com/farsider350/autx-core/commit/83af2d8d5) remove redundant wait_node
...
- [`7e4318dda`](https://github.com/farsider350/autx-core/commit/7e4318dda) Merge bitcoin#8329: Consensus: MOVEONLY: Move functions for tx verification (#3030)
...
- [`4e46f2511`](https://github.com/farsider350/autx-core/commit/4e46f2511) add end commend for all llmq namespace
...
- [`43c952d2e`](https://github.com/farsider350/autx-core/commit/43c952d2e) Merge #10632: qa: Add stopatheight test
...
- [`594eb7444`](https://github.com/farsider350/autx-core/commit/594eb7444) remove unneeded parenthesises
...
- [`39cfd61c0`](https://github.com/farsider350/autx-core/commit/39cfd61c0) Merge #9279: Consensus: Move CFeeRate out of libconsensus
...
- [`fbae76b21`](https://github.com/farsider350/autx-core/commit/fbae76b21) Merge #10011: build: Fix typo s/HAVE_DONTWAIT/HAVE_MSG_DONTWAIT
...
- [`c77c4330c`](https://github.com/farsider350/autx-core/commit/c77c4330c) Send less blocks to node1
...
- [`8c420c298`](https://github.com/farsider350/autx-core/commit/8c420c298) Merge #10344: [tests] Fix abandonconflict.py intermittency
...
- [`d9ac44740`](https://github.com/farsider350/autx-core/commit/d9ac44740) Merge #10283: Cleanup: reduce to one GetMinimumFee call signature
...
- [`f8c5a14f3`](https://github.com/farsider350/autx-core/commit/f8c5a14f3) Merge #9942: Refactor CBlockPolicyEstimator
...
- [`617c4a4cc`](https://github.com/farsider350/autx-core/commit/617c4a4cc) Use mapDSTX.find() instead of count() and []
- [`8df25bbfe`](https://github.com/farsider350/autx-core/commit/8df25bbfe) Call and implemente new signals in CPrivateSend
- [`816efa9cd`](https://github.com/farsider350/autx-core/commit/816efa9cd) Add missing directories to CMakeLists.txt and sort the list
- [`715a3e951`](https://github.com/farsider350/autx-core/commit/715a3e951) Move updating of txFirstSeenTime into TransactionAddedToMempool and BlockConnected
- [`a61127e1a`](https://github.com/farsider350/autx-core/commit/a61127e1a) Move filling of blockTxs into BlockConnected
- [`d4e75abbf`](https://github.com/farsider350/autx-core/commit/d4e75abbf) Call new signals in CChainLocksHandler
- [`25c40fe40`](https://github.com/farsider350/autx-core/commit/25c40fe40) Fix typo
- [`523304537`](https://github.com/farsider350/autx-core/commit/523304537) Don't check for posInBlock when updating pindexMined
- [`0b4f7b9b6`](https://github.com/farsider350/autx-core/commit/0b4f7b9b6) Move removal of mined-locks info to BlockDisconnected
- [`b645757be`](https://github.com/farsider350/autx-core/commit/b645757be) Call RemoveConflictedTx from BlockConnected instead of ProcessNewTransaction
- [`b36f0a324`](https://github.com/farsider350/autx-core/commit/b36f0a324) Call new signals instead of SyncTransaction on CInstantSendManager
- [`6afa605f6`](https://github.com/farsider350/autx-core/commit/6afa605f6) Pass disconnected/deleted pindex instead of pprev into BlockDisconnected
- [`9b8a750c9`](https://github.com/farsider350/autx-core/commit/9b8a750c9) More `boost::filesystem`->`fs` and some related cleanup
- [`250195185`](https://github.com/farsider350/autx-core/commit/250195185) Adjust CDSNotificationInterface to align with CValidationInterface changes
- [`d180061b8`](https://github.com/farsider350/autx-core/commit/d180061b8) Pass block index via BlockDisconnected
- [`282d1554d`](https://github.com/farsider350/autx-core/commit/282d1554d) adjust examples/autx.conf
- [`e451325d6`](https://github.com/farsider350/autx-core/commit/e451325d6) Merge #10186: Remove SYNC_TRANSACTION_NOT_IN_BLOCK magic number
- [`60438257a`](https://github.com/farsider350/autx-core/commit/60438257a) Merge #9725: CValidationInterface Cleanups
- [`f893ac66c`](https://github.com/farsider350/autx-core/commit/f893ac66c) Merge #10124: [test] Suppress test logging spam
- [`a54ff70ff`](https://github.com/farsider350/autx-core/commit/a54ff70ff) Merge #9902: Lightweight abstraction of boost::filesystem
- [`515343963`](https://github.com/farsider350/autx-core/commit/515343963) Merge #10036: Fix init README format to render correctly on github
- [`c8a565d6e`](https://github.com/farsider350/autx-core/commit/c8a565d6e) Merge #10090: Update bitcoin.conf with example for pruning
- [`6f558270d`](https://github.com/farsider350/autx-core/commit/6f558270d) Merge #10143: [net] Allow disconnectnode RPC to be called with node id
- [`4efa99c2d`](https://github.com/farsider350/autx-core/commit/4efa99c2d) Merge #10221: Stop treating coinbase outputs differently in GUI: show them at 1conf
- [`16053cd52`](https://github.com/farsider350/autx-core/commit/16053cd52) Merge #10226: wallet: Use boost to more portably ensure -wallet specifies only a filename
- [`7fa60a1c7`](https://github.com/farsider350/autx-core/commit/7fa60a1c7) Merge #10219: Tests: Order Python Tests Differently
- [`0b232fd1c`](https://github.com/farsider350/autx-core/commit/0b232fd1c) Merge #10208: [wallet] Rescan abortability
- [`55d1251ff`](https://github.com/farsider350/autx-core/commit/55d1251ff) Merge #9480: De-duplicate SignatureCacheHasher
- [`29194b1f5`](https://github.com/farsider350/autx-core/commit/29194b1f5) Backport Bitcoin#9424, Bitcoin#10123 and Bitcoin#10153 (#2918)
- [`15fa1873d`](https://github.com/farsider350/autx-core/commit/15fa1873d) Drop redundant imports and fix related code
- [`6f91144f2`](https://github.com/farsider350/autx-core/commit/6f91144f2) Fix p2p-fingerprint.py
- [`92fed9254`](https://github.com/farsider350/autx-core/commit/92fed9254) Fix and re-enable pruning.py
- [`bfeb5bca4`](https://github.com/farsider350/autx-core/commit/bfeb5bca4) fix txindex.py and add it to extended scripts
- [`c37008a45`](https://github.com/farsider350/autx-core/commit/c37008a45) update dip4-coinbasemerkalroots.py and llmq-is-cl-conflicts.py
- [`7fd979cc0`](https://github.com/farsider350/autx-core/commit/7fd979cc0) Merge #10114: [tests] sync_with_ping should assert that ping hasn't timed out
- [`4121daba2`](https://github.com/farsider350/autx-core/commit/4121daba2) Merge #10098: Make qt wallet test compatible with qt4
- [`cc06ef551`](https://github.com/farsider350/autx-core/commit/cc06ef551) Merge #10109: Remove SingleNodeConnCB
- [`94aa904c0`](https://github.com/farsider350/autx-core/commit/94aa904c0) Merge #10107: Remove unused variable. Remove accidental trailing semicolons in Python code
- [`404e244d1`](https://github.com/farsider350/autx-core/commit/404e244d1) Merge #10088: Trivial: move several relay options into the relay help group
- [`05cb5a058`](https://github.com/farsider350/autx-core/commit/05cb5a058) Merge #10108: ApproximateBestSubset should take inputs by reference, not value
- [`bfd63c179`](https://github.com/farsider350/autx-core/commit/bfd63c179) Merge #10076: [qa] combine_logs: Use ordered list for logfiles
- [`e57559a8d`](https://github.com/farsider350/autx-core/commit/e57559a8d) Merge #10096: Check that all test scripts in test/functional are being run
- [`c2258978b`](https://github.com/farsider350/autx-core/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
- [`6bb55d547`](https://github.com/farsider350/autx-core/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
- [`142b5cba0`](https://github.com/farsider350/autx-core/commit/142b5cba0) Merge #10073: Actually run assumevalid.py
- [`14001a3d9`](https://github.com/farsider350/autx-core/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
- [`120941793`](https://github.com/farsider350/autx-core/commit/120941793) Merge #10083: [QA] Renaming rawTx into rawtx
- [`1781c7a70`](https://github.com/farsider350/autx-core/commit/1781c7a70) Merge #10069: [QA] Fix typo in fundrawtransaction test
- [`379312931`](https://github.com/farsider350/autx-core/commit/379312931) Merge #9946: Fix build errors if spaces in path or parent directory
- [`ba20c9031`](https://github.com/farsider350/autx-core/commit/ba20c9031) Merge #10067: [trivial] Dead code removal
- [`ae05068c5`](https://github.com/farsider350/autx-core/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
- [`9f07f489d`](https://github.com/farsider350/autx-core/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
- [`96a5f5730`](https://github.com/farsider350/autx-core/commit/96a5f5730) Merge #9500: [Qt][RPC] Autocomplete commands for 'help' command in debug console
- [`07e0567dc`](https://github.com/farsider350/autx-core/commit/07e0567dc) Merge #9558: Clarify assumptions made about when BlockCheck is called
- [`2aa3f890d`](https://github.com/farsider350/autx-core/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/farsider350/autx-core/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/farsider350/autx-core/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/farsider350/autx-core/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/farsider350/autx-core/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/farsider350/autx-core/commit/67c735b15) s/bitcoin-config.h/autx-config.h/
- [`2f63322cd`](https://github.com/farsider350/autx-core/commit/2f63322cd) autxify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/farsider350/autx-core/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/farsider350/autx-core/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/farsider350/autx-core/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/farsider350/autx-core/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/farsider350/autx-core/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/farsider350/autx-core/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/farsider350/autx-core/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/farsider350/autx-core/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/farsider350/autx-core/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/farsider350/autx-core/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/farsider350/autx-core/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/farsider350/autx-core/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/farsider350/autx-core/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/farsider350/autx-core/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/farsider350/autx-core/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/farsider350/autx-core/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/farsider350/autx-core/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/farsider350/autx-core/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/farsider350/autx-core/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/farsider350/autx-core/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/farsider350/autx-core/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/farsider350/autx-core/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/farsider350/autx-core/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/farsider350/autx-core/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/farsider350/autx-core/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/farsider350/autx-core/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/farsider350/autx-core/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/farsider350/autx-core/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/farsider350/autx-core/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/farsider350/autx-core/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/farsider350/autx-core/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/farsider350/autx-core/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/farsider350/autx-core/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/farsider350/autx-core/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/farsider350/autx-core/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/farsider350/autx-core/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/farsider350/autx-core/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/farsider350/autx-core/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/farsider350/autx-core/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/farsider350/autx-core/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/farsider350/autx-core/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/farsider350/autx-core/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/farsider350/autx-core/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/farsider350/autx-core/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/farsider350/autx-core/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/farsider350/autx-core/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/farsider350/autx-core/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/farsider350/autx-core/commit/1cfda206a) Merge #9993: Initialize nRelockTime
