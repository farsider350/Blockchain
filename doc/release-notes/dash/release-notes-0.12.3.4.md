...
When deployed on testnet, it is required to start with a fresh data directory or call autx Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/autxpay/autx/compare/v0.12.3.3...autxpay:v0.12.3.4).
