...
- Added new units: `twigs` (1 / 100.000.000 DRK)
- Added units for testnet: tDRK, mtDRK, utDRK, ttwigs
...
- Add '-disablewallet' mode to let autxd run entirely without wallet (when
  built with wallet)
- Update default '-rpcsslciphers' to include TLSv1.2
- make '-logtimestamps' default on and rework help-message
- RPC client option: '-rpcwait', to wait for server start
- Remove '-logtodebugger'
- Allow `-noserver` with autxd
