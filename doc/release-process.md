...
* Update translations, see [translation_process.md](https://github.com/autxpay/autx/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/autxpay/autx/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/autxpay/autx.git
...
- Detached signatures will then be committed to the [autx-detached-sigs](https://github.com/autxpay/autx-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the autx.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the autx.org server

- Update autx.org

- Announce the release:

  - Release on autx forum: https://www.autx.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/autxpay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~autx.org/+archive/ubuntu/autx)

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/autxpay/autx/releases/new) with a link to the archived release notes.
