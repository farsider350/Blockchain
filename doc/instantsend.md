...
This mechanism has been integrated into Bitcore-Node-autx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/autxcore/insight-api-autx#web-socket-api](https://github.com/autxcore/insight-api-autx#web-socket-api)
* API: [https://github.com/autxcore/insight-api-autx#instantsend-transactions](https://github.com/autxcore/insight-api-autx#instantsend-transactions)
