UNIX BUILD NOTES
====================
Some notes on how to build autx Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Base build dependencies
-----------------------
Building the dependencies and autx Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your autx installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, autx Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, autx Core may be compiled in
