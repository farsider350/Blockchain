...
This document provides guidelines for internationalization of the autx Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `autx_en.ts` remains unchanged.
