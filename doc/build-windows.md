...
Below are some notes on how to build autx Core for Windows.
...
way. This will install to `c:\workspace\autx`, for example:

    make install DESTDIR=/mnt/c/workspace/autx
